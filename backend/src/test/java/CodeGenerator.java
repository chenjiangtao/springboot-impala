...
import static com.example.jason.common.model.ProjectConstant.MAPPER_INTERFACE_REFERENCE;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:impala://127.0.0.1:21050/test";
    private static final String JDBC_USERNAME = "svc";
    private static final String JDBC_PASSWORD = "svc";
    private static final String JDBC_DIVER_CLASS_NAME = "com.cloudera.impala.jdbc41.Driver";
     ...
     * 项目基础包名称
     */
    private static final String BASE_PACKAGE_PATH = "/com/example/jason";
    private static final String BASE_PACKAGE_ABSOLUTE_PATH = PROJECT_PATH + JAVA_PATH + "/com/example/jason";
    // controller 的路径 不一样
    private static final String CONTROLLER_PATH = PROJECT_PATH + "/web/src/main/java/com/example/jason";

    public static final String BASE_PACKAGE = "com.example.jason";
    ...
    private static final String AUTHOR = "Jason Chen"; // TODO 此处可替换作者
...
//        genCodeByCustomModelNameAndTemplate("user", "user", "User","simpleDict"); // 调用simpleDict的模板
        genCodeByCustomModelNameAndTemplate("crash", "log", "CrashLog","default"); // 调用simpleDict的模板
