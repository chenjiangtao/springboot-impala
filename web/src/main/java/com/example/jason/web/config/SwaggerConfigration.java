package com.example.jason.web.config;
...
public class SwaggerConfigration {
    ...
    private ApiInfo apiInfo() {
        ...
        apiInfoBuilder.description("博客:https://blog.csdn.net/evane1890/");
        apiInfoBuilder.termsOfServiceUrl("项目开源地址：https://gitee.com/chenjiangtao/spring-boot-impala");
